...
<p class="signup"><a href="http://tokentracker.com/app/signup.php" target="_blank">If you don\'t have a TokenTracker account and API key you can get one here for free &raquo;</a></p>
...
function tt_publish_entry($new_status, $old_status, $post) {
	...
	if ( $old_status != 'publish' &&  $new_status == 'publish' ) {
		...
		$token_img = false;
		$token_img = tt_getToken($api_key, $post->ID, $guid, $title, $description);
...
function tt_getToken($api_key, $post_id, $guid, $title = '', $description = '') {
